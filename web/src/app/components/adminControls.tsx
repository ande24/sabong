    ...
    <div className="grid grid-cols-1 md:grid-cols-10 gap-6 w-full">
      ...
      <div className="bg-gradient-to-b col-span-4 from-white justify-center via-white to-gray-400 rounded-xl shadow p-6 flex flex-col items-center gap-4 row-span-2">
        <div className="w-full grid grid-cols-2 gap-2">
          <button className="p-4 col-span-2 w-full bg-gradient-to-b from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white font-semibold text-2xl py-3 rounded mb-2 shadow transition">
            START NEW FIGHT
          </button>
          <button className="p-4 col-span-1 w-full bg-gradient-to-b from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white font-semibold text-xl py-3 rounded mb-2 shadow transition">
            START TV SCREEN
          </button>
          <button className="p-4 col-span-1 w-full bg-gradient-to-b from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white font-semibold text-xl py-3 rounded mb-2 shadow transition">
            SEARCH RECEIPT
      ...
      <div className="bg-gradient-to-b col-span-3 from-white via-white to-gray-400 rounded-xl shadow p-6 flex flex-col items-center">
        <div className="flex-col justify-center items-center w-full">
          ...
          <button className="w-full bg-gradient-to-b my-2 from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white text-xl py-2 rounded shadow transition">
            ADD PETTY CASH
          </button>
        </div>
      </div>
